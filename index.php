...
if (!empty($keyword_safe)) {
    $where = "WHERE 
                buku.judul_buku LIKE '%$keyword_safe%' OR
                buku.kategori LIKE '%$keyword_safe%' OR
                buku.penulis LIKE '%$keyword_safe%' OR
                buku.tahun_terbit LIKE '%$keyword_safe%'";
}

$totalDataQuery = "SELECT COUNT(*) AS total FROM buku 
                   INNER JOIN kategori ON buku.kategori = kategori.kategori
                   $where";
...
$dataQuery = "SELECT buku.*, kategori.kategori 
              FROM buku 
              INNER JOIN kategori ON buku.kategori = kategori.kategori
              $where
                ...
                <table class="table table-striped table-hover">
                  ...
                  <?php $no = 1; ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="ubah_data.php?id=<?= $row['id_buku']; ?>" class="btn btn-warning btn-sm">Edit</a>
                            <a href="hapus_data.php?id_buku=<?= $row['id_buku']; ?>" class="btn btn-danger btn-sm">Hapus</a>
                        </td>
                    </tr>
                    <?php endforeach; ?>
