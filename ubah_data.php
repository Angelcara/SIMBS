                ...
                <div class="container-fluid">
                 ...
                 <form action="" method="POST">
                            ...
                            <select class="form-control" name="kategori" required>
                                <?php foreach ($kategori as $row) : ?>
                                    <option value="<?= $row['kategori']; ?>"
                                        <?= ($row['kategori'] == $buku['kategori']) ? 'selected' : ''; ?>>
                                        <?= $row['kategori']; ?>
                                    </option>
                                <?php endforeach; ?>
                            </select>
                    ...
                    <!-- <select name="id_kategori" class="form-select" required>
                        <option value="<?= $buku['penulis'] ?>" autocomplete="off">-- Pilih Kategori --</option>
                        <?php foreach ($kategori as $kat): ?>
                            <option value="<?= $kat['id_kategori'] ?>" 
                                <?php if($kat['id_kategori'] == $buku['kategori']) echo 'selected'; ?>>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control" name="tanggal_input" id="tanggal_input" value="<?= $buku['tanggal_input'] ?>">
                    </div>
                    <div class="mb-3">
