...
$kategori = [];
$result = mysqli_query($conn, "SELECT id_kategori, kategori FROM kategori ORDER BY kategori ASC");
...
<body class="layout-fixed sidebar-expand-lg bg-body-tertiary">
    ...
    <div class="app-wrapper">
        ...
        <!--end::Header-->
        <!--begin::Sidebar-->
        <aside class="app-sidebar shadow" data-bs-theme="dark" style="background-color: #444444ff;">
            <!--begin::Sidebar Brand-->
                        ...
                        <div class="col-md-6">
                            ...
                            <form action="" method="post">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="id_kategori" class="form-select" required>
                                        ...
                                        <?php foreach ($kategori as $kat): ?>
                                            <option value="<?= $kat['id_kategori'] ?>"><?= htmlspecialchars($kat['kategori']) ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="tahun_terbit" placeholder="yy">
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">Tanggal Input</label>
                                    <input type="date" class="form-control" name="tanggal_input" placeholder="yyyy-mm-dd">
                                </div>
                                <div class="mb-3">
